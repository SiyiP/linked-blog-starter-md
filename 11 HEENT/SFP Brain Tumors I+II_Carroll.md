...
see whiteness on the contrast enhancing on the L temporal lobe - 3 masses 
operating room of open biopsy - seen squash prep + frozen section 
	squash prep - cytoogy of iindividual cells
we see neoplasm + evidence of tumor necrosis + thicker BVs
permenant section - superior quality - seen a lot of thickness + neoplasm 
- immunoreactive staine for GFP 
- 5% are p53+ and 12% labeled for Ki67 
- no IDH1 R132H mutation 
dx - glioblastoma 
- impact memory + speech bc it's dominant temporal lobe affecting 
- contrast enhancement - bc of the leaky bvs
- determining prognosis - absence of idh1 r132h mutation 

note:
common types of primary tumors in kids + adults
grading is important and staging is useless for most of these 

WHO classification of tumors of CNS - there's too many... and it's also badly out of date - focus on major concepts + the big common ones 
...
2. oligodendroglioma - myelinated glia in the CNS... also seen **calcifications!!!**
	1. fried **EGG APPEARANCE due to artifact**
	2. they will lack marked atypia, brisk mitotic rate, vasc prolf + tumor necrosis 
	3. they are only grade 2 
	4. <mark style="background: #FFF3A3A6;">codeletion of 1p and 19q</mark> - better survival + 
...
4. primary CNS lymphomas - arises AIDs patients are here
	...
	2. **perivascular pattern of growth**
The cancer genome atlas - 
- ot id the molecular abnormalities and stuff. 
- you need to see which subgroups you can look at 
- TCGA.  = 4 GBM subtypes - proneural, neural, classical, mesenchymal 
	- **IDH1 = novel oncogene .... if you have mutation here your survival is better**
	- changes the function of the enzyme - makes alc metabolite - which will change the epigenetics. 

integrated dx - we will use molecular and histo reasons to classify patients. no more mixed gliomas. 

---
memory issues, 38 yo, confused + blunted affect + no focal deficits
- contrast enhancing lesion of left frontal lobe infiltrating into dura, extending into ventricular system + crossing corpus callosum 
- nests of tumor cells - **sharply demarcated from adjacent tissue... CK7, GATA3, e-cadherin, high mitosis + extensive necrosis**
- **metastatic breast cancer** = this is metastasis bc 
	- <mark style="background: #FFF3A3A6;">well circumscribed, so since they're from outside the braint hey're not able to infiltrate the brain that well.</mark>
	- multiple lesions 
	- at gray-white junctions ; on the other hand gliomas are more in the white matter. 
	- large numbers of mitotic figures are present 

---

benign CNS tumors in adults 
1. meningiomas - are over half of these, the majority 
	1. adheres to the dura, ar dural based masses
	2. **on radiology they appear to be in the lateral ventricle!!**
	3. enduce hyperostosis of skull  - thickened skull bone
	4. can cause marked edema in adacent brain - 
	...
	10. malignant meninigioma 
		1. rare highly aggressive
		2. excessive miitosis + anaplastic 

2. pituitary adenomas - super common 
	1. they are intrasellar tumors from hormone secreting cells of **anterior pituitary**
	2. hormone secretion + clinical symptomsor mass effect not secretors 
	3. cannot be predicting by histo - that's why we don't use WHO 

3. schwannomas 
	1. benign **periipheral nerve sheath tumors** - grade 1 
	2. commonly occur in **8th !!! cranial nerve and spinal cord nerve roots but happen on any nerve**
	3. symptoms related to which cranial nerve they're on ... like hearing loss on the 8th or pain on the dorsal spinal nerve roots 
	4. these are composed exclusively of **neoplastic schwann cells, which aren't true of the other pierpheral nerve shealth tumors like neurofibromas and mpnsts**
	5. don't infiltrate nerve!!!! they are **encapsulated masses and push on that nerve to dmg it, never will transform**
	6. treat : surgery 
4. craniopharyngiomas - grade 1 
	1. 2 major types: 
	2. adamantinomatous - in kids - epithelial **sellar region - which will compress the optic chiasm, so pituitary dysfunction, visual symptoms and can press on CSF so hydrocephaluous**
		1. note - contrast enhancing 
		2. partilaly calcified
		3. partially cystic 
		4. **state of utah crystals are seen = rhomboidal**
	3. papillary craniopharyngiomas - in **adulthood**
		1. above the sellar, or 3rd ventricle!!! 
		2. present with similar symptoms - 
		3. but **different epithelium - lacking the stratum granulosom...**

---
NS neoplasms in KIDS!
CNS - **this is the most common neoplasm 
...
5. Neurofibromatosis 2 - more central ... 
	...
	4. NF2 gene lifespan is shortened 
	5. NF2 gene -> encodes protein known as merlin/schwannomin which **mediates communication bt cell surface membrane of cytoskeleton**
...
- these don't have the bilateral acoustic schwannomas, meningiomas or ependymomas.. but schwannomas elsewhere which make intratable tumor-related pain ; super pain ): 
