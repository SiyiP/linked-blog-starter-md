...
case 1 
- suddenly at 9 - progressive neuro deterioraton 
- unilateral paresis of upper limb 
- walking difficulties, then aphasia, lethargy, abnormal movements + tremors observed
- 5 mon later freq generalized tonic clonic seizures + falls 
- given carbamazepine - helped a lot but then 2 months wore off 

persistent viral infection. - it stays in host after acute symptmos ended
recall - CNS is immune privileged so things can hide there easily 
how do things persist
- infection of host is not cytolytic - lacks transcription factors for cytolytic replication .... 
	- they're well differentiated like neurons or microglia 
- viral genome maintained 
	- DNA + retroviruses integrate into genome 
	- episome - using plasmid thing via DNA viruses 
	- unknown mech - RNA viruses 
- evasion from immune system 
	- CNS is immune privileged 
	- antigenic variation + virokines - thru maybe even losing genes to proteins 

viral agents in progessive neuro dz 
conventional agents - measles, rubella, JC polyoma virus, AIDS, enteroviruses 
- they have nucleic acid genome
- protein capsids
- grow in cultures
- persist via infection of nonpermissive cells, mutations that reduce antigenicity or other, mutations that resist norm replication 

unconventional = genome req for persistence doesn't apply 
- prions - dont have a genome 
