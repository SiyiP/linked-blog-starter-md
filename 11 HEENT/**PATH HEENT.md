...
facial 
 pain distribution in CN V, usually V2. 
...
2. cleft plate - palatine shelves + nasal septum. 
	1. form the maxillary, palate hard and / or soft 
	2. fused here - involving the <mark style="background: #FFF3A3A6;">medionasal prominnence </mark>
	3. deep maxillary -> cleft palate ;
rare clefts
...
4. **pierre robin sequence**
	1. maldev of 1st pharyngeal arch 
	2. micrognathia - underdevelopped mandible (arch); super recessed chin/jaw hard for them to breathe. 
	3. glossoptosis - posterior displacement of the tongue, the palatine plates and stuff would be placed too far back, from the ceiling in the medial area downwards... so cleft palate is made 
		1. short mandible / mandibular hypoplasia before week 9 -> displace big tongue posterirly ; **glossoptosis**
		2. **palatal shelves can't fuse**
		3. cleft palate!
	4. ear anomales due to the cleft + pouch 
		1. triad: miicrognathia, glossoptosis, airway obstructure with cleft palate 73-90% U shaped , wide cleft palate 
	5. feeding + breathing difficulties, middle ear dysfunction as recurrent ottitis media 
5. treacher collins syndrome -mandibulofacial dysostosis , serioous 
	1. mandibular hypoplasia - or j not develop 
	...
	5. **bilateral symmetric involvement**
	6. lower eyelid <mark style="background: #FFF3A3A6;">colobomas</mark> - **notches + gaps in eyelid tissue = wiith displacement of zygomatic bones** ; slanted palpebral fissures, orbital rim defects too. 
	7. more serious - airway obstruction with **micrognathia ): hard to intubate them with cleft palate + breathing issues**, feeding hard, hearing loss structurally , and req lots of care
	8. normal cog development 
	9. often inivolve the <mark style="background: #FFF3A3A6;">TCOF1</mark> gene chrom 5 
...
thyroglossal duct remnants  - can get infected and seen anywhere along that path f the thyroid 
...
1st/2nd branchial anomalies - 
- cyst = walled off
- sinus = opening into the skin 
- fistula = opening like tube to another structure 
- work type 1 = ectoderm derived, j **superficial to the facial nerve, so lateral to it and less common
- work type 2 = more serious - ectoderm + mesoderm derived, lined by sq epithelium + has adnexa + cartilage, course around CN7 is all variable, exiting near cheek 
	- we need to get the superficial parotidectomy to find the facial nerve to remove that cyst or whatever...

2nd branchial anomalies- more common - a fistula anterior to the SCM, and facial nerve is the cyst
...
external ear - 
- any arrest of ext ear dev = microtia. 
- mostly sporadic maybe insjury to the stapedial artery or some teratogenic 
- graded :  = **floppy stick out ears**, 2 has all structures but small. 3 = some cartilage but requires reconstructure, and 4 = no ears ; **conductive hearing loss grade 3+**
- prominorris - having all the structures, but most cartilage is missing, might need or want otoplasty with some cutting of skin 
- observation til 5-8 years old ++ allows bone browth of ribs + development of contralateral **normal ear
- we should **repair microtiia external ear before atresia**
often ppl wh have this have <mark style="background: #FFF3A3A6;">oculo-auriculo-vertebral spectrum = OAVs</mark>
...
- cleft palate would have more fluid = higher risk of otitis media bc th levator will open up to the ear ; we need to avoid feeding tubes if we don't need it... can't make suction so failure to thrive. 
- - cleft lip + alveolus - **attempt moms feeding method + monitor closely weight**
NAM - nasoalveolar molding - with a device where you bring out the premaxilla - surgical with taping+ lip repair . 
...
- - positioning, nasopharyngeal airway placement, CPAP + supp o2  = conservative treatments 
- surgical : tracheostomy, tongue lip adhesion, mandibular distraction osteogeneiss
	- MDO = will directly address primary problem of micrognathia and long term benefits by lengthening the mandible - one way to elongate the jaw  = need longterm followup 
...
- cells that will go thru the radial glia -> cortex. = this is physiological 
...
1. focal = destruction all the way down to the center - 
	1.  seizures common , some ventricles but too much space, porencephaly loss of gray matter
2. widespread = hydranecephaly - MCA and midline destruction  - cells never make it to that cortex ; is normal then just abruptly stops 
3. cavum septum - super common = 2 separate leaflets in septum in between the lateral hemispheres, never fuse!!! small cave/hole bt the 2 lateral ventricles - no effect
4. corpus callosum agenesis 
	1. "bat sign" on imaging 
	2. can be isolated/associated
	3. partial - based on lipoma not making it dev normally? 
5. spinal cord malformatin - 
	1. hydromelia - central canal too big, abnormal widening of the central canal of the spinal cord that creates a cavity in which cerebrospinal fluid 
	2. springomyelia - with tissue hole, can see as developmental issue or with some kinda  tumor ; development of a fluid-filled cyst within the spinal cord.
	3. diastomyelia - centrally there's a separator that makes 2 divisions of a canal - usually in lumbosacral region 
		1. **Diastematomyelia, a type of spina bifida**, describes a congenital spinal dysraphism resulting in a split cord malformation. The spinal cord is longitudinally divided into two 'hemicords,' each surrounded by its own dural tube and separated by a midline bony spur or cartilaginous or fibrous ridge or band.

brain injuries in perinatals... and premies most commonly 
