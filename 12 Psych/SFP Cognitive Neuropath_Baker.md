...
many causes of cognitive impairment - a lot 
- like vascular - stroke, global hypoxic-ischemic
- trauma
- congenital 
- autoimmune like ms and so on 

commonalities of all neurodegen 
- neuron death - loss of cell bodies + axons
- rarefaction = white spaces on brain loss of brain substance = more empty 
- gliosis glial rxn to injury like astrocytes
...
- 2/2 multiple subcortical infarcs / ischemic lesions 
	...
	- lacunar infarcs look like white space around bv rarefaction, vague triangular areas, and then the pinkish eosinophilic color surrounding is gliosis in the brain bgd.![[gliosis subcortical infarcs and hyaline arteriosclerosis.png]] vasc dementia - think infarcs 
- stepwise deterioraton - acute decline to another acute decline
	...
	- basically gross findings will depend on location + nature of the lesion . 
	- lacunar infarc - a slit little lesion 
	- hydrocephalus ex vacuo - enlarged ventricls in rsponse to inc pressure
	- in the deep gray matter we see more lacunar infarcs which are small holes that are long looking in the brain matter - involving basal ganglia. 
	- note the asymmetry bt L + R basal ganglia 
- basically a chronic progressive dementia caused by the dmg of the infarcs
- stepwise deterioration impacting memory, mood, cognition 
- psychiatric symptoms + focal motor signs
...
- classic extracellular hallmark of Alzheimer disease.<mark style="background: #FFF3A3A6;"> These plaques consist of a central core of β-amyloid surrounded by swollen, tortuous neurite</mark>s. Their presence aligns sharply with the patient's progressive memory loss, disorientation, and profound cognitive decline.
alzheimers dz - AD
- most common form of dementia 
- usually begins after 50 
- incidence inc with each decade of life
- majority = sporadic. minoritys familial !!!
- slowly but consistently progressive, over 5-10+ years
- memory issues -> intellectual motor impairment -> severe loss of cognitive, speech, motor skills 
- gross. path - generalized atrophy - gyri have larger gap of sulci in between. 
	- most notable - frontal and temporal lobes are set apart 
	- relative sparing of occipital and sensory motor cortex. 
- on mri - we see atrophy with large ventricles and the sylvian fissure we see how expanded they are
	1. <mark style="background: #FFF3A3A6;">amyloid beta depositions </mark>- made secondary to cleavage of amyloid precursor protein app by **beta-secretase**
		1. abnormal structures - amyloid plaque and amyloid angiopathy (in bvs)
		2. transmembrane protein and then we dono't know what it normally does.... 
		3. many enzymes that would cleave, with alpha and gamma secrtase which would allow regular recycling and allows body to get rid of it... but if the beta one cleaves it will cause plaques. 
	...
	2. <mark style="background: #FFF3A3A6;">tau, hyperphosphorylated - neurofibrillary tangles </mark>
...
- alz genetic associations: 
	...
	2. <mark style="background: #FFF3A3A6;">apo e = apolipoprotein involved in gen and depo of amyloid, high risk with amyloid accumualation </mark>
	3. <mark style="background: #FFF3A3A6;">presenillins</mark> - mutations leading to<mark style="background: #FFF3A3A6;"> loss of function in alpha secretase, associated with early onset AD </mark>


frontal or temporal lobar degeneration - <mark style="background: #FFF3A3A6;">FTLD</mark>
- peaks 45-65, 
- 80% sporadic
- <mark style="background: #FFF3A3A6;">frontal lobe invlvement = personality and behavior changes</mark>
- temporal lobe predom = <mark style="background: #FFF3A3A6;">aphasia + memory loss</mark>
- terminally like all these other illnesses - pts have severely demented, mute state like AD
- may be seen in<mark style="background: #FFF3A3A6;"> combo with parkinsonism or motor neuron dz</mark> (<mark style="background: #FFF3A3A6;">TDP-43 mutation which is ALS</mark>) so many of these combo cases are familial
	- FTLD-TDP (like with ALS TDP-43 mutation)
		- where the<mark style="background: #FFF3A3A6;"> nucleus is blue and brown inclusion inside</mark>
		- there's like<mark style="background: #FFF3A3A6;"> a cat's eye in the neuron. </mark>
...
- <mark style="background: #FFF3A3A6;">we see phospho-tau reactive neurons, distribution of tau are in depths of sulci... cerebral cortex.!!!!!</mark>
	- tau depo is widespread in this one 
...
- <mark style="background: #FFF3A3A6;">creutzfeld-jakoob disease</mark> - CJD most common !
	...
	- and startle myoclonus
	  EEG = <mark style="background: #FFF3A3A6;">periodic sharp wave copmlexes</mark>, imaging too with diffusion restriction of cortex ? and deep gray nuclei 
