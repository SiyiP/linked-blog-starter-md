...
MSE overview = should reflec dz process, a snapshot in time as dynamic not static + elicit evidence of metnal/psych dysfucntion + prep others for patient interactions 
components
- behavioral - cooeprative, stress? how pts act to the examiner
- psych = how they function emotionall, organizes their thoughts, assessing hallucinations
- neurological - how their nervous system is doing ? aphasias, memory, orientatin, and otherwise tremors 


elements!!!
how do they appear? and how they're interacting during interview 
	appearance
		think - dress, grooming, hygiene, posture, id the patient, note distingushing characteristics 
		"appears stated age, appropriate grooming + hygiene"
	behavior
		how they're behaving during interview + other ppl? 
		eye contact looks like ? 
		how react to the stress of an interview 
	motor/gait
		no psychomotor retardation or activation, no tremor, normal gait
		some level of activities? EPS assessment, abnormal movements
		gait, balance, tremor 
		remember to thnk abt pertnent negatives 
	speech/lang
		appropriate rate rhythm volume + tone?
		- <mark style="background: #FFF3A3A6;">prosody = element of rhythm/cadence, emotional character/tone</mark>
		- latency - prolonged perioid bt thought + verbal expression like with catatonia 
		- neurologic - slurring? dysarthria, aphasia, fluency etc. 
		
how are they functioning psychologically during interview 
	mood
		what do they say during the interview - put in quotes 
	affect
		what do u see/ability to emote?
		range of affect = think range of emotion broad/full range or narrow/constricted 
	...
	thought process 
		linear logical and goal directed is normal 
	...
	judgement
		ability to *make* decisions based on appropriate insight 
		apply this to specifically their pathology/why they are there. 
what's their neurocognitive functioning like during interview 
	orientation 
		4 W - who, where, when, why 
...
- just a small context of age, edu lvl, overall functioning 
- one score doesn't mean anything - no speciic qs associatd with dementia 
- used best for following a patient inpatient without dx 

moca - montreal cog assessment
- out of 30 
- 26+ is normal 
- accounts for highest edu level
- more sensitive for ppl with higher intellectual level
- sensitvie for mild cog impairment
- assessing exec functioning!!! 